...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "molisiye"
    user-mail-address "molisiye@live.com")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/molisiye/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/molisiye/bin" "/profile/bin" "/Users/molisiye/.npm-packages/bin" "/Users/molisiye/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
